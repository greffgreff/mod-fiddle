...
//        TowerPiece tower = new TowerPiece(dynamicRegistries, chunkGenerator, templateManager, centerPos, Rotation.NONE, random, loc);
        DeckPiece deck = new DeckPiece(dynamicRegistries, chunkGenerator, templateManager, centerPos.add(0,30,0), Rotation.randomRotation(random), random, loc);
